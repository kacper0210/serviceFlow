  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const ordersList = data.assignedOrders.map((o) => `• ${o.title} (ID: ${o.id})`).join("\n");
        alert(`Nie można usunąć klienta, ponieważ ma przypisane zlecenia:\n\n${ordersList}`);
      } else {
          ...
          {editingClient === client.id ? (
            ...
            >
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <button type="button" onClick={() => setEditingClient(null)} style={btnCancel}>
                  ✖ Anuluj
                </button>
              </div>
            </form>
